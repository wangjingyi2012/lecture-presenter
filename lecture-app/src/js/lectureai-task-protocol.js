...
(function attachLectureAiTaskProtocol(global) {
  ...
  const CONTRACT = Object.freeze({
    ...
    capabilities: Object.freeze(['deck.plan.v3', 'slide.read', 'slide.write.transactional', 'slide.insert', 'slide.delete', 'slide.reorder', 'outline.write', 'deck.validate', 'render.diagnostics.v1', 'task.receipts.v1', 'task.revert.v1', 'deck.digests.v1', 'deck.snapshot.v1', 'patch.apply.v1', 'render.measure.v1']),
  ...
  const INTERNAL_TERMS = /\b(?:pi(?:\s+(?:agent|runtime))?|runtime|write_slide|insert_slide|delete_slide|reorder_slides|finalize_deck|render_template|validate_slide|validate_deck|set_deck_plan|apply_patch|measure_render)\b/gi;
